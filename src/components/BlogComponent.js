    ...
    <section id="blog">
      <div className="container">
        ...
        <div className="neoh_fn_title">
          <h3 className="fn_title">Media & Partners </h3>
          <div className="line">
            <span />
          </div>
        </div>
          ...
          <ul>
            <li>
              <div className="item">
                ...
                <p className="fn_desc">
                  Welcome to 'Which Future' Dive into a compelling podcast series hosted by Begum Bitir, exploring the intersection of sustainability and exponential technologies.  Discover how industries embrace innovative solutions to combat the 
                  looming climate crisis and shape a brighter, more eco-conscious future.
                </p>
                <p className="fn_read">
                  <Link href="/blog-single">
            ...
            <li>
              <div className="item">
                ...
                <p className="fn_desc">
                  Delve into the world of social entrepreneurship with our podcast as we unravel the core principles guiding impactful ventures. Join us to understand how innovative business models merge with social responsibility, 
                  paving the way for positive change and sustainable impact in communities worldwide. Let's uncover the secrets of driving a successful venture while making a difference in society.
                </p>
                <p className="fn_read">
                  <Link href="/blog-single">
                    <a className="neoh_fn_button only_text">
